...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] name = {"Thanh ha","Thanh Hoang", "Thanh Hieu", "Thanh Mong"};
        String[] lastMessage = {"Let's Catchup","Dinner tonight?","Gotta go","any Weekend Plans?"};
        String[] lastMsgTime = {"8:45 pm","9:00 am","7:34 pm","6:32 am"};
        String[] phoneNo = {"7656610000","9999043232","7834354323","9876543211"};
        String[] country = {"VietNamese","Russia","Germany","France"};;
